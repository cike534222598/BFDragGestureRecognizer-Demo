...
- (void)showUI
{
    ...
    for (int i = 0; i < count; i++) {
        ...
        DragGestureRecognizer *holdDragRecognizer = [[DragGestureRecognizer alloc] init];
        [holdDragRecognizer addTarget:self action:@selector(dragRecognized:)];
        [view addGestureRecognizer:holdDragRecognizer];
    }
}

- (void)dragRecognized:(DragGestureRecognizer *)recognizer {
